...
class Pegawai extends CI_Controller
{
	...
	{
		// $data['dashboard'] = $this->m_pegawai->tampil_data()->result();
	...
	public function pdf1()
	{
		...
		$mahasiswa = $this->db->get('tb_pegawai')->result();
		$no = 0;
	...
	public function exportExcel()
	{
		...
		$no = 1;
		foreach ($data as $row) {
			$writer->writeSheetRow('Sheet1', [$no, $row['nama'], $row['nip'], $row['tgl_lahir']], $styles2);
			$no++;
		}
